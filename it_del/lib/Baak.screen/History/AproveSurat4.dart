...
class ApproveSuratScreen4 extends StatefulWidget {
  @override
  _ApproveSuratState4 createState() => _ApproveSuratState4();
}

class _ApproveSuratState4 extends State<ApproveSuratScreen4> {
  ...
  Future<void> retrievePosts() async {
    try {
      ...
      ApiResponse response = await getSemuaAdminSurat();
