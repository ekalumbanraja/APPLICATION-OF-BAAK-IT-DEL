...
class AproveIBScreen2 extends StatefulWidget {
  @override
  _AproveIBScreenState2 createState() => _AproveIBScreenState2();
}

class _AproveIBScreenState2 extends State<AproveIBScreen2> {
  ...
  Future<void> retrievePosts() async {
    try {
      ...
      ApiResponse response = await getSemuaAdminIzinBermalam();
