...
class AproveIKScreen3 extends StatefulWidget {
  @override
  _AproveIK3ScreenState3 createState() => _AproveIK3ScreenState3();
}

class _AproveIK3ScreenState3 extends State<AproveIKScreen3> {
  ...
  Future<void> retrievePosts() async {
    try {
      ...
      ApiResponse response = await getSemuaAdminIzinKeluar();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('History Izin Keluar'),
      ),
      body: _loading
