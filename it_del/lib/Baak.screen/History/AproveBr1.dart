...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ApproveBrScreen1(),
    );
  }
}

class ApproveBrScreen1 extends StatefulWidget {
  @override
  _ApproveBrScreenState1 createState() => _ApproveBrScreenState1();
}

class _ApproveBrScreenState1 extends State<ApproveBrScreen1> {
  ...
  Future<void> retrievePosts() async {
    try {
      ...
      ApiResponse response = await getSemuaAdminRequestRuangan();
